...
fig = go.bar(data, x=data['Player Name'], y=[data['Touches'], data['Passes Completed']], width=int(0.5))
...
fig = go.bar(data, x=data['Player Name'], y=[data['Assists'], data['Goals']], width=int(0.1))
fig.update_layout(legend_title_text='Stats')
fig.update_xaxes(title_text="Player Name")
fig.update_yaxes(title_text="Touches and Passes Completed")
